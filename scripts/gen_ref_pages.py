...
for path in sorted(sorted(src.rglob("*.py")), key=sort_init_first):
    ...
    if module_name == "__init__" and init_as_section_index_page:
        ...
        mod_path_left_nav = module_ident if show_full_path_left_nav else module_name
        mod_path_footer_nav = module_ident if show_full_path_footer_nav else module_name
